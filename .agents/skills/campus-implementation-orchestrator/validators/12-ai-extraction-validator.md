...
## Purpose
Run email fixtures through strict structured extraction; validate content types, categories, dates/timezone, confidence, ambiguity handling, and no auto-publish.
